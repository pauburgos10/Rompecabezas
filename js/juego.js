...
function intercambiarPosicionesGrilla(filaPos1, columnaPos1, filaPos2, columnaPos2) {
  var auxGrilla = grilla[filaPos1][columnaPos1];
  grilla[filaPos1][columnaPos1] = grilla[filaPos2][columnaPos2];
  grilla[filaPos2][columnaPos2] = auxGrilla;
}
...
var cambiarVisibilidadDeElementos = function () {
  document.getElementById("cantMovimientos").classList.toggle("invisible");
  document.getElementById("flecha").classList.toggle("invisible");
}
...
function intercambiarPosiciones(filaNueva, colNueva, filaAnterior, colAnterior) {
  // Intercambio posiciones en la grilla
  var piezaMovida = grilla[filaNueva][colNueva];
  var nuevaVacia = grilla[filaAnterior][colAnterior];
  console.log("pieza Movida" + piezaMovida + " pieza anterior " + nuevaVacia);

  intercambiarPosicionesGrilla(filaNueva, colNueva, filaAnterior, colAnterior);
  console.log("valores:" +filaNueva+ "/"+ colNueva+ "/"+ filaAnterior+"/"+colAnterior)
  intercambiarPosicionesDOM('pieza' + piezaMovida, 'pieza' + nuevaVacia);
...
function mostrarMovimientos(){
  textMovimientos = document.getElementById('cantMovimientos');
  textMovimientos.textContent = movimientos.length;
}
...
presiona el usuario */
function iniciar() {
  instrucciones.push("Utilizar las flechas para mover las piezas");
  instrucciones.push("Ordenar las piezas hasta alcanzar la imagen objetivo");
